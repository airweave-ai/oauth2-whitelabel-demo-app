...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        messageElement.textContent = 'Your Slack workspace has been connected. Data sync will begin shortly.';
    } catch (error) {
        console.error('Failed to complete OAuth flow:', error);
        statusElement.textContent = 'Error';
        messageElement.textContent = 'Failed to connect your Slack workspace. Please try again.';
    }
}); 